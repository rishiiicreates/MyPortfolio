...
const experiences = [
    {
        ...
        description: "Developing and deploying automated workflows by connecting internal systems with AI models, eliminating manual data entry bottlenecks and accelerating operational efficiency.",
        tech: ["Python", "AI Models", "Automation", "Internal Systems"]
    },
    {
        role: "AI Strategy and Business Intelligence Intern",
        company: "IBM",
        period: "December 2025 - April 2026",
        description: "Trained an XGBoost classifier on 120k samples achieving an 87% F1-score for predictive business insights. Deployed scalable inference APIs using FastAPI and Docker, hosted on Render for high-availability enterprise access. Engineered automated data pipelines integrating fine-tuned LLMs and TensorFlow to extract structured metrics from raw datasets.",
        tech: ["Python", "FastAPI", "Docker", "TensorFlow", "XGBoost"]
    },
    {
        role: "Generative AI Engineer (Freelance)",
        company: "Wildish & Co.",
        period: "October 2024 - August 2025",
        description: "Developed an AI-driven automated debugging pipeline by integrating predictive ML models, reducing manual QA ticket resolution time. Fine-tuned transformer models for anomaly detection in application logs, boosting system stability and performance profiling.",
        tech: ["Python", "Transformers", "ML", "Debugging Pipelines"]
    }
];
