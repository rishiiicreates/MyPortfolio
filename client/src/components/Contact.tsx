    ...
    <section id="contact" className="py-32 bg-accent text-background relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24">
          ...
          <a href="mailto:rishiicreates@icloud.com" className="group flex items-center gap-4 mt-8 md:mt-0">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                { name: "Email", href: "mailto:rishiicreates@icloud.com", icon: Mail }
              ].map((social, i) => (
                <a key={i} href={social.href} className="flex items-center gap-4 text-2xl font-display uppercase hover:opacity-70 transition-opacity">
