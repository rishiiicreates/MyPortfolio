        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-start">
          ...
          <div className="md:w-7/12 flex flex-col gap-12 pt-12 md:pt-24">
            ...
            >
              ...
              {/* Journey Button - Integrated */}
              <div className="flex justify-end mt-8">
                <Magnetic>
                  <a href="/journey" className="group flex items-center gap-4 cursor-pointer">
                    <span className="font-mono text-xs uppercase tracking-widest text-foreground/60 group-hover:text-accent transition-colors">
                      View Full Log
                    </span>
                    <div className="w-12 h-12 rounded-full border border-foreground/20 flex items-center justify-center group-hover:border-accent group-hover:bg-accent/5 transition-colors relative overflow-hidden">
                      <span className="font-display font-bold text-lg group-hover:translate-x-1 transition-transform">→</span>
                    </div>
                  </a>
                </Magnetic>
              </div>
