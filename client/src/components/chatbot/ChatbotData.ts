...
export const chatbotAnswers: ChatAnswer[] = [
  ...
  },
  {
    ...
    answer: "You can contact Hrishikesh via email at rishiicreates@gmail.com or through any of the social media platforms listed in the Contact section."
  },
  {
    keywords: ["skills", "expertise", "what can you do", "capabilities", "languages"],
    answer: "Hrishikesh is skilled in C++, Python, JavaScript/TypeScript, and SQL. He works with frameworks like React, Next.js, Node.js, TensorFlow, Scikit-Learn, Pandas, NumPy, and LangChain. On the cloud/tools side, he uses AWS, Firebase, Vercel, Render, Git/GitHub, Docker, Kubernetes, and Hugging Face."
  },
  {
