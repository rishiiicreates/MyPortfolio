...
export default function AboutMe() {
    ...
    return (
        <section className="min-h-screen bg-background pt-32 pb-20 px-6 md:px-12">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <motion.h1 variants={itemVariants} className="font-display font-bold text-5xl md:text-7xl leading-[0.9] text-foreground">
                        Hey there! 👋 <br />
